...
private function Save_Object_Character takes integer pid returns nothing
    ...
    call JNObjectCharacterSetInt( Get_User_Id(), "UNIT_TYPE", GetUnitTypeId(u) )
    ...
    exitwhen i >= 6
        ...
        call JNObjectCharacterSetInt( Get_User_Id(), "UNIT_ITEM" + I2S(i), value )
    endloop
    ...
    exitwhen i >= 6
        ...
        call JNObjectCharacterSetInt( Get_User_Id(), "BAG_0_ITEM" + I2S(i), value )
    endloop
    ...
    exitwhen i >= 6
        ...
        call JNObjectCharacterSetInt( Get_User_Id(), "BAG_1_ITEM" + I2S(i), value )
    endloop
...
private function Save_Object_User takes integer pid returns nothing
    ...
    call JNObjectUserSetInt(Get_User_Id(), "GOD_INT1", udg_GOD_INT1[pid+1])
    call JNObjectUserSetInt(Get_User_Id(), "GOD_INT2", udg_GOD_INT2[pid+1])
    call JNObjectUserSetInt(Get_User_Id(), "GOD_INT3", udg_GOD_INT3[pid+1])
    call JNObjectUserSetInt(Get_User_Id(), "ITEM_A_COUNT", udg_ITEM_A_COUNT[pid+1])
    call JNObjectUserSetInt(Get_User_Id(), "ITEM_B_COUNT", udg_ITEM_B_COUNT[pid+1])
